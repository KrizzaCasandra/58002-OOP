...
#widgets start from here
        self.lbl1 = Label(win, text="1st No." , bg="Pink")
        self.lbl1.place(x=100, y=50)

        self.lbl2 = Label(win, text= "2nd No." , bg="Pink")
        self.lbl2.place(x=100, y=100)

        self.lbl3 = Label(win, text="Result" , bg="Pink")
        self.lbl3.place(x=100, y=150)

        self.txt1 = Entry(win, bd=1 , bg="#f4c2c2")
        self.txt1.place(x=200, y=50)

        self.txt2 = Entry(win, bd=1 , bg="#f4c2c2")
        self.txt2.place(x=200, y=100)

        self.txt3 = Entry(win, bd=3 , bg="#f4c2c2")
