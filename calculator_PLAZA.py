...
#widgets start from here
        ...
        self.btnadd = Button(win, text="Addition" , fg = "Teal" , bg = "White")
        self.btnadd.place(x=400, y=85)
        self.btnadd.bind('<Button-1>', self.add)

        self.btnsub = Button(win, text="Subtraction" , fg = "Teal" , bg = "White")
        self.btnsub.place(x=400, y=120)
        self.btnsub.bind('<Button-1>', self.sub)

        self.btnmulti = Button(win, text="Multiplication", fg = "Teal", bg = "White" , command = self.multi)
        self.btnmulti.place(x=400, y=155)

        self.btndivi = Button(win, text="Division", fg = "Teal", bg = "White" , command = self.divi)
        self.btndivi.place(x=400, y=190)

        self.btnclr = Button(win, text="Clear" , fg= "Pink" , bg = "White")
